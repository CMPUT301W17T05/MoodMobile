...
public class TestMoodList extends ActivityInstrumentationTestCase2 {
    ...
    public void testFilterByType(){
    	...
    	//filter and check
    	//return 1
    	MoodList filtered = moods.filterByType("Sad");
    	assertTrue(filtered.size() = 1);
    	Mood filteredMood = filtered.index(0);
    	assertTrue(filteredMood = newMood2);
    	assertFalse(filteredMood = newMood1);
    	...
    	//filter and check
    	//return 0
    	MoodList filtered = moods.filterByType("Angry");
    	assertTrue(filtered.size() = 0);
    ...
    public void testFilterWithWord(){
    	...
    	//filer and check
    	//return 1
    	MoodList filtered = moods.filterWithWord("two");
    	assertTrue(filtered.size() = 1);
    	Mood filteredMood = filtered.index(0);
    	assertTrue(filteredMood = newMood2);
    	assertFalse(filteredMood = newMood1);
    	...
    	//filter and check
    	//return 2
    	MoodList filtered = moods.filterWithWord("test");
    	assertTrue(filtered.size() = 2);
    	Mood filteredMood = filtered.index(0);
    	assertTrue(filteredMood = newMood1);
    	assertFalse(filteredMood = newMood2);
    	...
    	//filter and check
    	//return 2
    	MoodList filtered = moods.filterWithWord("test word:");
    	assertTrue(filtered.size() = 2);
    	Mood filteredMood = filtered.index(0);
    	assertTrue(filteredMood = newMood1);
    	assertFalse(filteredMood = newMood2);
